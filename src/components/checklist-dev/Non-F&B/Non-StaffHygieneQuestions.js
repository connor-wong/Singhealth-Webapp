...
import "../../../App.css";
import { Staff_Hygiene } from "../../../data/nonChecklistQuestions";
import { Container, Row, Col, Table } from "react-bootstrap";

class NonStaffHygieneQuestions extends Component {
  constructor() {
    super();
    this.state = {
      selectedChoices: [],
...
export default NonStaffHygieneQuestions;
