...
import "../../../App.css";
import { Fire_Emergency_Safety } from "../../../data/nonChecklistQuestions";
import { Container, Row, Col, Table } from "react-bootstrap";

class NonFireEmergencySafetyQuestions extends Component {
  constructor() {
    super();
    this.state = {
      selectedChoices: [],
          ...
          <Row>
            <Col xl={12} lg={12} md={12} sm={12} xs={12}>
              <Table size="sm" borderless className="question-table">
                <tbody>
                  {Fire_Emergency_Safety.map((question) => {
                    return (
                      <tr key={question.id}>
                        <td>
...
export default NonFireEmergencySafetyQuestions;
