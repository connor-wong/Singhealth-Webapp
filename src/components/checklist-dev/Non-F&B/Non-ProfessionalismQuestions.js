...
import "../../../App.css";
import { Professionalism } from "../../../data/nonChecklistQuestions";
import { Container, Row, Col, Table } from "react-bootstrap";

class NonProfessionalismQuestions extends Component {
  constructor() {
    super();
    this.state = {
      selectedChoices: [],
...
export default NonProfessionalismQuestions;
