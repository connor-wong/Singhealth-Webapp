...
import "../../../App.css";
import { Electrical_Safety } from "../../../data/nonChecklistQuestions";
import { Container, Row, Col, Table } from "react-bootstrap";

class NonElectricalSafetyQuestions extends Component {
  constructor() {
    super();
    this.state = {
      selectedChoices: [],
          ...
          <Row>
            <Col xl={12} lg={12} md={12} sm={12} xs={12}>
              <Table size="sm" borderless className="question-table">
                <tbody>
                  {Electrical_Safety.map((question) => {
                    return (
                      <tr key={question.id}>
                        <td>
...
export default NonElectricalSafetyQuestions;
