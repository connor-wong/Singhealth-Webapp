...
class NonGeneralSafetyQuestionsPartOne extends Component {
  constructor() {
    super();
    this.state = {
      selectedChoices: [],
...
class NonGeneralSafetyQuestionsPartTwo extends Component {
  constructor() {
    super();
    this.state = {
      selectedChoices: [],
...
export { NonGeneralSafetyQuestionsPartOne, NonGeneralSafetyQuestionsPartTwo };
