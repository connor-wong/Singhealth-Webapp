...
class StaffHygieneQuestionsPartOne extends Component {
  constructor() {
    super();
    this.state = {
      selectedChoices: [],
          ...
          <Row>
            <Col xl={12} lg={12} md={12} sm={12} xs={12}>
              <Table size="sm" borderless className="question-table">
                <tbody>
                  {Staff_Hygiene_Part_One.map((question) => {
                    return (
                      <tr key={question.id}>
                        <td>
...
class StaffHygieneQuestionsPartTwo extends Component {
  constructor() {
    super();
    this.state = {
      selectedChoices: [],
        ...
        <Container fluid>
          ...
          <Row>
            <Col xl={12} lg={12} md={12} sm={12} xs={12}>
              <Table size="sm" borderless className="question-table">
                <tbody>
                  {Staff_Hygiene_Part_Two.map((question) => {
                    return (
                      <tr key={question.id}>
                        <td>
                          <h3>{question.question}</h3>
...
export { StaffHygieneQuestionsPartOne, StaffHygieneQuestionsPartTwo };
