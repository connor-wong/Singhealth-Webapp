...
import "../../../App.css";
import { Hand_Hygiene_Facilities } from "../../../data/checklistQuestions";
import { Container, Row, Col, Table } from "react-bootstrap";

class HandHygieneFacilitiesQuestions extends Component {
  constructor() {
    super();
    this.state = {
      selectedChoices: [],
          ...
          <Row>
            <Col xl={12} lg={12} md={12} sm={12} xs={12}>
              <Table size="sm" borderless className="question-table">
                <tbody>
                  {Hand_Hygiene_Facilities.map((question) => {
                    return (
                      <tr key={question.id}>
                        <td>
...
export default HandHygieneFacilitiesQuestions;
