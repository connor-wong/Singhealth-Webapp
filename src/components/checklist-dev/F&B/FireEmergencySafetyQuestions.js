...
import "../../../App.css";
import { Fire_Emergency_Safety } from "../../../data/checklistQuestions";
import { Container, Row, Col, Table } from "react-bootstrap";

class FireEmergencySafetyQuestions extends Component {
  constructor() {
    super();
    this.state = {
      selectedChoices: [],
...
export default FireEmergencySafetyQuestions;
