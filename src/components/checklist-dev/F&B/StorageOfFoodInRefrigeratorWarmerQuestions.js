...
class StorageOfFoodInRefrigeratorWarmerQuestionsPartOne extends Component {
  constructor() {
    super();
    this.state = {
      selectedChoices: [],
        ...
        <Container fluid>
          <Row>
            <Col xl={12} lg={12} md={12} sm={12} xs={12}>
              <h1>Storage of Food in Refrigerator/Warmer</h1>
            </Col>
          </Row>
          ...
          <Row>
            <Col xl={12} lg={12} md={12} sm={12} xs={12}>
              <Table size="sm" borderless className="question-table">
                <tbody>
                  {Storage_Food_Refrigerator_Warmer_Part_One.map((question) => {
                    return (
                      <tr key={question.id}>
                        <td>
...
class StorageOfFoodInRefrigeratorWarmerQuestionsPartTwo extends Component {
  constructor() {
    super();
    this.state = {
      selectedChoices: [],
        ...
        <Container fluid>
          ...
          <Row>
            <Col xl={12} lg={12} md={12} sm={12} xs={12}>
              <Table size="sm" borderless className="question-table">
                <tbody>
                  {Storage_Food_Refrigerator_Warmer_Part_Two.map((question) => {
                    return (
                      <tr key={question.id}>
                        <td>
                          <h3>{question.question}</h3>
